...
def main():  
    ...
    if word[0:2] == "LS":
        ...
        tot = size - numberFin
        modstring = ()
        modstring = namevariable[:tot]
        final = modstring + "#" * numberFin
        ...
        numberFin = int(float(numberChars))
        tot = size - numberFin
        final = "#" * numberChars + namevariable[:tot]
    
    elif word[0:2] == "LC":
        numberChars = word[3:4]
        size = len(namevariable)
        numberFin = int(float(numberChars))
        part = namevariable[0:numberFin] 
    ...
    if secondfunction[0:2] == "LS":
        ...
        if direction == 'L':
            ...
            final = final[:startFin] + leftrotate(subString, numberFin) + final[totalFin:]
            return final
        if direction == 'R':
            totalFin = totalFin + startFin
            subString = final[startFin:totalFin]
            final = final[:startFin] + rightrotate(subString, numberFin) + final[totalFin:]
